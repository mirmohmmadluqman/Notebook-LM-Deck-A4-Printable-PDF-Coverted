...
export default function PdfEditorPage() {
  ...
  const [newText, setNewText] = useState('New text appended to the document.');
  ...
  const handleEdit = async () => {
    ...
    try {
      ...
      console.error(err);
      setError('An error occurred while editing the document.');
    } finally {
    ...
    <main className="min-h-screen p-6 sm:p-12 max-w-3xl mx-auto flex flex-col gap-8">
      <header className="flex flex-col gap-2 border-b pb-6 text-center sm:text-left">
        ...
        <p className="text-lg text-gray-600">
          Append a new page with custom text to your PDF.
        </p>
      </header>
      ...
      <div className="flex-1 flex flex-col gap-8">
          ...
          <section className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none"
              />
            </div>
          </section>
        )}
        ...
        <section className="pt-4 border-t">
          <button
            onClick={handleEdit}
            disabled={!file || !newText.trim() || isProcessing}
